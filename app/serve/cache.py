...
async def cache_key(key_hash: str, environment_id: str, org_id: str, plan: str, env_name: str, api_key_id: str):
    await _cache.set(
        f"key:{key_hash}",
        {
...
async def cache_prompt(
    ...
    content: str, version_num: int, version_id: str, variables: dict, prompt_id: str
):
    await _cache.set(
